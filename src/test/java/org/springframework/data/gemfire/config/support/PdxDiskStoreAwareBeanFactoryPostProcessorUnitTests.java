...
public class PdxDiskStoreAwareBeanFactoryPostProcessorUnitTests {
	...
	protected static void assertDependencies(BeanDefinition beanDefinition, String... expectedDependencies) {
		assertThat(ArrayUtils.isEmpty((Object) beanDefinition.getDependsOn())).isFalse();
	...
	public void postProcessBeanFactory() {
		...
		assertThat(ArrayUtils.isEmpty((Object) beanDefinitions.get("gemfireCache").getDependsOn())).isTrue();
		assertThat(ArrayUtils.isEmpty((Object) beanDefinitions.get("pdxDiskStore").getDependsOn())).isTrue();
		assertThat(ArrayUtils.isEmpty((Object) beanDefinitions.get("someOtherBean").getDependsOn())).isTrue();
